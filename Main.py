...
from preprocessing import Preprocessing,Test_Script
...
Train_data,Trained_variables = Preprocessing(Train_data)
Test_data = Test_Script(Test_data,Trained_variables)
